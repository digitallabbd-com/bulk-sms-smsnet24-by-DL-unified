...
final class EducareHooks {
    public function register(): void {
        add_action('educare_student_added', [$this, 'on_student_added'], 10, 1);
        add_action('educare_result_published', [$this, 'on_result_published'], 10, 2);
        add_action('educare_attendance_saved', [$this, 'on_attendance_saved'], 10, 2);
    }
    ...
    public function on_student_added($student_id): void {
        ...
        (new Sender())->queue($phone, $msg, ['event' => 'educare_student_added', 'student_id' => (int) $student_id]);
    }
    ...
    public function on_result_published($exam_id, $student_id): void {
        ...
        (new Sender())->queue($phone, $msg, ['event' => 'educare_result_published', 'student_id' => (int) $student_id, 'exam_id' => (int) $exam_id]);
    }
